...
- Use `PascalCase()` for global/free functions, including namespace-local
  helpers, and static methods.
...
- Declarations and implementations have empty separator lines, except grouped
  private, uncommented one-line inline function/method definitions.
- Global/free functions and static methods use PascalCase.
